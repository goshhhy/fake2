...
field_t fields[] = {
    ...
    // need for item field in edict struct, FFL_SPAWNTEMP item will be skipped
    // on saves
...
field_t levelfields[] = {{"changemap", LLOFS( changemap ), F_LSTRING},
...
field_t clientfields[] = {{"pers.weapon", CLOFS( pers.weapon ), F_ITEM},
