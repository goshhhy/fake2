...
void Boss2MachineGun( edict_t *self ) {
    /*	vec3_t	forward, right;
       ...
       monster_flash_offset[flash_number], forward, right, start);
        ...
        VectorSubtract (vec, start, dir);
        VectorNormalize (dir);
        monster_fire_bullet (self, start, dir, 3, 4, DEFAULT_BULLET_HSPREAD,
...
mframe_t boss2_frames_stand[] = {
    ...
    ai_stand, 0, NULL, ai_stand, 0, NULL, ai_stand, 0, NULL, ai_stand, 0, NULL,
    ai_stand, 0, NULL};
mmove_t boss2_move_stand = {FRAME_stand30, FRAME_stand50, boss2_frames_stand,
                            NULL};
...
mmove_t boss2_move_fidget = {FRAME_stand1, FRAME_stand30, boss2_frames_fidget,
                             NULL};
...
mframe_t boss2_frames_run[] = {
    ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL,
    ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL,
    ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL,
    ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL,
    ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL, ai_run, 8, NULL};
...
mmove_t boss2_move_attack_pre_mg = {FRAME_attack1, FRAME_attack9,
                                    boss2_frames_attack_pre_mg, NULL};
...
mmove_t boss2_move_attack_mg = {FRAME_attack10, FRAME_attack15,
                                boss2_frames_attack_mg, NULL};

mframe_t boss2_frames_attack_post_mg[] = {
    ai_charge, 1, NULL, ai_charge, 1, NULL,
    ai_charge, 1, NULL, ai_charge, 1, NULL};
mmove_t boss2_move_attack_post_mg = {FRAME_attack16, FRAME_attack19,
                                     boss2_frames_attack_post_mg, boss2_run};
...
mframe_t boss2_frames_attack_rocket[] = {
    ...
    ai_charge, 1,   NULL,        ai_charge, 1, NULL, ai_charge, 1, NULL,
    ai_charge, 1,   NULL,        ai_charge, 1, NULL, ai_charge, 1, NULL,
    ai_move,   -20, Boss2Rocket, ai_charge, 1, NULL, ai_charge, 1, NULL,
    ai_charge, 1,   NULL,        ai_charge, 1, NULL, ai_charge, 1, NULL,
    ai_charge, 1,   NULL,        ai_charge, 1, NULL, ai_charge, 1, NULL};
mmove_t boss2_move_attack_rocket = {FRAME_attack20, FRAME_attack40,
                                    boss2_frames_attack_rocket, boss2_run};
...
mmove_t boss2_move_pain_heavy = {FRAME_pain2, FRAME_pain19,
                                 boss2_frames_pain_heavy, boss2_run};

mframe_t boss2_frames_pain_light[] = {ai_move, 0, NULL, ai_move, 0, NULL,
                                      ai_move, 0, NULL, ai_move, 0, NULL};
mmove_t boss2_move_pain_light = {FRAME_pain20, FRAME_pain23,
                                 boss2_frames_pain_light, boss2_run};
...
mmove_t boss2_move_death = {FRAME_death2, FRAME_death50, boss2_frames_death,
                            boss2_dead};
