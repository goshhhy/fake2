...
mframe_t makron_frames_stand[] = {
    ...
    ai_stand, 0, NULL, ai_stand, 0, NULL, ai_stand, 0, NULL, ai_stand, 0, NULL,
    ai_stand, 0, NULL, ai_stand, 0, NULL, ai_stand, 0, NULL, ai_stand, 0, NULL,
    ai_stand, 0, NULL, ai_stand, 0, NULL  // 60
};
mmove_t makron_move_stand = {FRAME_stand201, FRAME_stand260,
                             makron_frames_stand, NULL};
...
mframe_t makron_frames_run[] = {ai_run, 3,  makron_step_left,
                                ...
                                ai_run, 6,  NULL,
                                ai_run, 12, NULL};
mmove_t makron_move_run = {FRAME_walk204, FRAME_walk213, makron_frames_run,
                           NULL};
...
mframe_t makron_frames_walk[] = {ai_walk, 3,  makron_step_left,
                                 ...
                                 ai_walk, 6,  NULL,
                                 ai_walk, 12, NULL};
mmove_t makron_move_walk = {FRAME_walk204, FRAME_walk213, makron_frames_run,
                            NULL};
...
mframe_t makron_frames_pain6[] = {
    ...
    ai_move, 0, NULL,  // 10
    ai_move, 0, NULL,         ai_move, 0, NULL, ai_move, 0, NULL,
    ai_move, 0, NULL,         ai_move, 0, NULL, ai_move, 0, makron_popup,
    ai_move, 0, NULL,         ai_move, 0, NULL, ai_move, 0, NULL,
    ai_move, 0, NULL,  // 20
    ai_move, 0, NULL,         ai_move, 0, NULL, ai_move, 0, NULL,
    ai_move, 0, makron_taunt, ai_move, 0, NULL, ai_move, 0, NULL,
    ai_move, 0, NULL};
mmove_t makron_move_pain6 = {FRAME_pain601, FRAME_pain627, makron_frames_pain6,
                             makron_run};

mframe_t makron_frames_pain5[] = {ai_move, 0, NULL, ai_move, 0, NULL,
                                  ai_move, 0, NULL, ai_move, 0, NULL};
mmove_t makron_move_pain5 = {FRAME_pain501, FRAME_pain504, makron_frames_pain5,
                             makron_run};

mframe_t makron_frames_pain4[] = {ai_move, 0, NULL, ai_move, 0, NULL,
                                  ai_move, 0, NULL, ai_move, 0, NULL};
mmove_t makron_move_pain4 = {FRAME_pain401, FRAME_pain404, makron_frames_pain4,
                             makron_run};
...
mmove_t makron_move_death2 = {FRAME_death201, FRAME_death295,
                              makron_frames_death2, makron_dead};
...
mframe_t makron_frames_death3[] = {
    ...
    ai_move, 0, NULL, ai_move, 0, NULL, ai_move, 0, NULL, ai_move, 0, NULL,
    ai_move, 0, NULL, ai_move, 0, NULL, ai_move, 0, NULL, ai_move, 0, NULL};
mmove_t makron_move_death3 = {FRAME_death301, FRAME_death320,
                              makron_frames_death3, NULL};
...
mframe_t makron_frames_sight[] = {
    ...
    ai_move, 0, NULL, ai_move, 0, NULL, ai_move, 0, NULL, ai_move, 0, NULL,
    ai_move, 0, NULL};
mmove_t makron_move_sight = {FRAME_active01, FRAME_active13,
                             makron_frames_sight, makron_run};
...
mframe_t makron_frames_attack3[] = {
    ...
    ai_move,   0, NULL, ai_move,   0, NULL,
    ai_move,   0, NULL, ai_move,   0, NULL};
mmove_t makron_move_attack3 = {FRAME_attak301, FRAME_attak308,
                               makron_frames_attack3, makron_run};
...
mframe_t makron_frames_attack4[] = {ai_charge, 0, NULL,
                                    ...
                                    ai_move,   0, NULL,
                                    ai_move,   0, NULL};
mmove_t makron_move_attack4 = {FRAME_attak401, FRAME_attak426,
                               makron_frames_attack4, makron_run};
...
mframe_t makron_frames_attack5[] = {
    ...
    ai_move,   0, NULL,
    ai_move,   0, NULL};
mmove_t makron_move_attack5 = {FRAME_attak501, FRAME_attak516,
                               makron_frames_attack5, makron_run};

void MakronSaveloc( edict_t *self ) {
    VectorCopy( self->enemy->s.origin, self->pos1 );  // save for aiming the
                                                      // shot
...
void MakronHyperblaster( edict_t *self ) {
    ...
    monster_fire_blaster( self, start, forward, 15, 1000, MZ2_MAKRON_BLASTER_1,
                          EF_BLASTER );
}
...
/*QUAKED monster_makron (1 .5 0) (-30 -30 0) (30 30 90) Ambush Trigger_Spawn
 * Sight
 */
